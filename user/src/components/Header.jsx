...
import { MapPin, Bell, LogOut, User, Calendar, Search, Home } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link to="/home" className="flex items-center gap-2.5">
            ...
            <span className="font-extrabold text-lg text-[#1A1A1A] tracking-tight">Workzarr</span>
          </Link>

          {user && (
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FFF0EB] border border-[#FFC0AC] rounded-full text-[#FF4500] text-xs font-semibold">
